...
(function ($) {
    ...
    }, beforePageText: "第", afterPageText: "页,共 {pages}页", displayMsg: "当前第 {from} 到 {to} 共 {total} 条", nav: { first: { iconCls: "pagination-first", handler: function () {
...
(function ($) {
    ...
    }, length: { validator: function (_42c, _42d) {
        var len = $.trim(_42c).length;
        return len >= _42d[0] && len <= _42d[1];
    }, message: "Please enter a value between {0} and {1}."
    }, remote: { validator: function (_42e, _42f) {
        var data = {};
        data[_42f[1]] = _42e;
