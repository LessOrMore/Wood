...
namespace WoodDBUtility
{
    public class SQLiteHelper
    {
        ...
        public static Boolean CreateTable(string SQLString)
        {
        ...
        public static void CreateDataBase(ref string errText)
        {
            try
            {
                string sql = connectionString.Substring(12);
                if (File.Exists(sql))
                {
            ...
            {
                errText = "创建数据库失败" + ex.ToString().Substring(1, 60);
            }
        }
        ...
        public static void RollbackTransaction(SQLiteTransaction tran)
        {
            tran.Rollback();
        ...
        /// </summary>
        /// <param name="tran"></param>
        public static void CommitTransaction(SQLiteTransaction tran)
        {
            tran.Commit();
            if (tran.Connection != null)
            {
